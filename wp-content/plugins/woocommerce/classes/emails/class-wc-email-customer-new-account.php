...
class WC_Email_Customer_New_Account extends WC_Email {
	...
	var $user_email;
	var $user_pass;
	var $rpr_school = 'testing';
	var $rpr_program;


    //var $rpr_program = get_user_meta( $user_id, rpr_program, true ); 
	...
	function trigger( $user_id, $user_pass = '' ) {
		...
		if ( $user_id ) {
			...
			$this->rpr_program =  stripslashes( $this->object->rpr_program );
		}
	...
	function get_content_html() {
		...
		woocommerce_get_template( $this->template_html, array(
			...
			'rpr_school'	=> $this->rpr_school,
			'rpr_program'	=> $this->rpr_program,
