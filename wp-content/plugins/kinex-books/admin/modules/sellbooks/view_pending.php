...
function view_pending_reservation()
{
...
?>	
	<div class="wrap">
        ...
        <h2>All Pending Reservation Records</h2>
        ...
        <ul class="subsubsub">
            ...
            | <li class="all"><a class="current" href="admin.php?page=<?php print $_GET['page']; ?>" style="color:#D54E21;">Pending <span class="count"> (<?php print $total_pending ?>)</span></a> </li>
            <?php endif; ?>
...
jQuery.ajax({
		...
		var url = "admin.php?page=view_pending_reservation";
...
<!--Status update coding end here-->
	...
	<div class="tablenav bottom">
		...
		<div class="tablenav-pages one-page">
        	<span class="displaying-num"><?php print $total_pending; ?> items</span>
