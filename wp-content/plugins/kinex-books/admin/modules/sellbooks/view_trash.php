...
?>	
	<div class="wrap">
        ...
        <h2>All Trash Sell Books Listview</h2>
       
        <ul class="subsubsub">
		
			<li class="all"><a class="current" href="admin.php?page=sellbooklist">All Records<span class="count"> (<?php print $total_rec ?>)</span></a> </li>
		
            <?php if( $trash_items>0 ):	?>
            | <li class="all"><a class="current" href="admin.php?page=<?php print $_GET['page']; ?>" style="color:#D54E21;">Trash <span class="count"> (<?php print $trash_items ?>)</span></a> </li>
            <?php endif; ?>
...
<table cellspacing="0" class="wp-list-table widefat fixed users">
	...
	<tr>
		...
		<th style="width:50px;" class="manage-column column-name sortable <?php print $wmclass; ?>" scope="col">
        
        	<span>Sno.</span><span class="sorting-indicator"></span>
    ...
    <?php 
		...
		<td class="role column-role"><a href="javascript:void(0)"><?php print $c; ?></a></td>
        ...
        <td class="username column-name">
             ...
             if(current_user_can('manage_options')): ?>   
                <span class="delete">
                	<a href="admin.php?page=delete&amp;id=<?php print $hswp_table[$i]->id; ?>" class="submitdelete" onclick="return confirm_delete_msg('Are You Sure to Delete This Booking Permanently?')">Delete</a>
                </span>
              <?php endif;
             
              if(current_user_can('manage_options')): ?>   
                <span class="delete">
                	| <a href="admin.php?page=restore&amp;id=<?php print $hswp_table[$i]->id; ?>" class="submitdelete" onclick="return confirm_delete_msg('Are you sure to restore this booking?')">Restore</a>
                </span>
               <?php endif;?>  
		...
		<td class="role column-role">$<input type="text" id="est_amt-<?php print $hswp_table[$i]->id; ?>" value="<?php print $hswp_table[$i]->estimate_amount; ?>" name="estimate_amount" maxlength="4" size="4"> <a id="send-offer-<?php print $hswp_table[$i]->id.'-'.$hswp_table[$i]->email.'-'.$url; ?>" class="send-offer button" href="javascript:void(0)" title="Send Offer">Send Offer</a></td>
...
<!--Status update coding end here  --> 
	...
	<div class="tablenav bottom">
		...
		<div class="tablenav-pages one-page">
        	<span class="displaying-num"><?php print $trash_items; ?> items</span>
