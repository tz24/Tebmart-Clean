...
class plugin_white_label_branding {
	...
	function plugin_white_label_branding($args=array()){
		...
		if(is_admin()){
			...
			rh_register_php('rh-functions', WLB_PATH.'options-panel/rh-functions.php', $this->options_panel_version);
		}
	}
	...
	function plugins_loaded(){
		...
		if($version<3.3){
			...
			require_once WLB_PATH.'includes/class.prewp38_wlb_branding.php';
		}else{
		...
		if($version<3.5){
			...
			require_once WLB_PATH.'includes/class.prewp38_wlb_color_scheme.php';
		}else{
