...
function wccs_install() {
	$defaults = array( 'buttons' => array( array(
			...
			'option_c' =>  __('option 3', 'woocommerce-checkout-manager')
...
<th style="width:5%;" class="wccs-order" title="<?php esc_attr_e( 'Change order' , 'woocommerce-checkout-manager' ); ?>"></th>
		...
		<th><?php _e('Placeholder' , 'woocommerce-checkout-manager' ); ?></th>
				...
				<th><?php _e('Options C' , 'woocommerce-checkout-manager' ); ?></th>
...
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">
		  ...
		  <td><input type="text" name="wccs_settings[buttons][<?php echo $i; ?>][option_c]"  
          value="<?php echo esc_attr( $options['buttons'][$i][option_c] ); ?>" /></td>
...
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">
	   ...
	   <td><input type="text" name="wccs_settings[buttons][<?php echo $i; ?>][option_c]" 
       title="<?php esc_attr_e( 'Insert Option C', 'woocommerce-checkout-manager' ); ?>" value="" /></td>
