...
class WEV_Email_Verification{
	...
	public function send_verification($to, $un, $pw, $hash){
		...
		$message = "
			...
			<div style='margin:0 auto; width:600px; padding: 70px 0px;'>
				...
				<div style='background-color:#f4ae34;'>
					<h1 style='color: #fff; margin: 0px; padding: 28px 24px; text-shadow: rgb(246, 190, 93) 0px 1px 0px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: left; line-height: 150%;' >Activate Account</h1>
				</div>
		...
		$message .= "
					<p style='color:#505050'>Want to know how to buy or sell books? Please visit: <a href='http://www.tebmart.com/process/' title='Process'>click here</a>
					Get to know us, please visit:  <a href='http://www.tebmart.com/about-us/' title='About Us'>click here</a>
					Or follow us on <a href='https://www.facebook.com/pages/Tebmart/1443316865899682' title='Facebook'>Facebook</a> and <a href='https://twitter.com/Teb_Mart' title='Twitter!'>Twitter!</a>
					Once again, thank you joining the Tebmart community!
					<br /><strong>Tebmart</strong></p>
